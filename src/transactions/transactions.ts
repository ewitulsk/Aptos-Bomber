...
async function createMintTransaction(client: AptosClient, account: AptosAccount, maxGas: bigint = BigInt(2000), gasPrice: bigint = BigInt(1)) {
    const entryFunctionPayload = new TransactionPayloadEntryFunction(
        EntryFunction.natural(
          ...
          [BCS.bcsSerializeStr("0x100000000000000")], //<-- This line is sketchy
        ),
    );
